...
if(${CMAKE_HOST_SYSTEM_NAME} STREQUAL "Linux")
    ...
    if(${ARCH} STREQUAL "amd64")
        set(BUILD_OPTION "${BUILD_OPTION} --target=x86_64-linux-gnu -L/usr/lib/gcc-cross/x86_64-linux-gnu/${GCC_VERSION} -L/usr/x86_64-linux-gnu/lib -I/usr/x86_64-linux-gnu/include -I/usr/x86_64-linux-gnu/include/c++/${GCC_VERSION} -I/usr/x86_64-linux-gnu/include/c++/${GCC_VERSION}/x86_64-linux-gnu")
    elseif(${ARCH} STREQUAL "i386")
        set(BUILD_OPTION "${BUILD_OPTION} --target=i686-linux-gnu -L/usr/lib/gcc-cross/i686-linux-gnu/${GCC_VERSION} -L/usr/i686-linux-gnu/lib -I/usr/i686-linux-gnu/include -I/usr/i686-linux-gnu/include/c++/${GCC_VERSION} -I/usr/i686-linux-gnu/include/c++/${GCC_VERSION}/i686-linux-gnu")
    ...
    elseif(${ARCH} STREQUAL "armv6")
        set(BUILD_OPTION "${BUILD_OPTION} -march=armv6 -mfpu=vfp -marm --target=arm-linux-gnueabihf -L/usr/lib/gcc-cross/arm-linux-gnueabihf/${GCC_VERSION} -L/usr/arm-linux-gnueabihf/lib -I/usr/arm-linux-gnueabihf/include -I/usr/arm-linux-gnueabihf/include/c++/${GCC_VERSION} -I/usr/arm-linux-gnueabihf/include/c++/${GCC_VERSION}/arm-linux-gnueabihf")
